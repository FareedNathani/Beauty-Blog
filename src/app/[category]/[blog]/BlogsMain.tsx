...
const BlogsMain = ( {params} : { params: { blog: string}  } ) => {
    ...
    <div className="mt-[100px] mb-[100px]">
      ...
      <h1 className='flex mt-2 lg:mb-4 text-myverydarkpink'><a href="https://github.com/FareedNathani"><MdAccountCircle className='text-3xl mr-3' /></a> Fareed Nathani <span className='ml-4'> November 22 2024</span></h1>
