    ...
    <div className='justify-center mx-auto text-myverydarkpink'>
      ...
      <div>
        ...
        <ul className="space-y-2">
          ...
          <h1 className='text-myverydarkpink font-bold lg:text-[17px]'>Pinned By Fareed Nathani</h1>
          <h1 className='flex mt-2 lg:mb-4 text-myverydarkpink'><a href="https://github.com/FareedNathani"><MdAccountCircle className='text-3xl mr-3' /></a> Fareed Nathani <span className='ml-4'> November 12 2024</span></h1>
          ...
          <h1 className="flex gap-2">Connect with me on LinkedIn<a href="https://www.linkedin.com/in/fareed-nathani-30180a324/" ><FaLinkedin className="text-[22px] font-bold"/></a></h1>
